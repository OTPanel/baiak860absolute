accountManager = "yes"
	...
	maxPlayers = 109
	motd = "Bem Vindo ao Baiak criado por Absolute"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = false
	serverName = "Baiak Absolute"
	loginMessage = "Bem Vindo ao Baiak criado por Absolute"
	...
	ownerName = "Absolute on Tibiaking"
	ownerEmail = "absolute@tibiaking.com"
